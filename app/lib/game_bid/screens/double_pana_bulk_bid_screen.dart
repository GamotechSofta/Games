...
class DoublePanaBulkBidScreen extends StatefulWidget {
  ...
  @override
  State<DoublePanaBulkBidScreen> createState() =>
      _DoublePanaBulkBidScreenState();
}
    ...
    return GameBidLayout(
      ...
      body: ListView(
        ...
        children: [
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Row(
                              children: _quickPoints.map((p) {
                                final sel =
                                    _groupBulkCtrls[groupKey]?.text.trim() ==
                                    '$p';
                                return Padding(
          ...
          if (selected.isEmpty)
            Text(
              'No selected double pana yet',
              style: GameBidUi.emptyHint(context),
            )
          else
            ...selected
                .take(30)
