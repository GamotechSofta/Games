                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex flex-row items-center gap-2">
                                ...
                                <input
                                    ...
                                    className={`flex-1 min-w-0 bg-white dark:bg-[#202124] border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white placeholder-gray-500 rounded-full py-2.5 min-h-[40px] px-4 text-center text-sm focus:ring-2 focus:outline-none ${
                                        openPanaInvalid ? 'border-red-500 focus:border-gray-500 focus:ring-red-500/20' : 'focus:ring-[#d4af37]/30 focus:border-gray-200 dark:border-white/10'
                                    }`}
                                />
                            </div>
                            ...
                            <div className="flex flex-row items-center gap-2">
                                ...
                                <input
                                    ...
                                    placeholder="Ank"
                                    className="flex-1 min-w-0 bg-white dark:bg-[#202124] border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white placeholder-gray-500 rounded-full py-2.5 min-h-[40px] px-4 text-center text-sm focus:ring-2 focus:ring-[#d4af37]/30 focus:border-gray-200 dark:border-white/10 focus:outline-none"
                                />
                            </div>
                            ...
                            <div className="flex flex-row items-center gap-2">
                                ...
                                <input
                                    ...
                                    placeholder="Point"
                                    className="no-spinner flex-1 min-w-0 bg-white dark:bg-[#202124] border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white placeholder-gray-500 rounded-full py-2.5 min-h-[40px] px-4 text-center text-sm focus:ring-2 focus:ring-[#d4af37]/30 focus:border-gray-200 dark:border-white/10 focus:outline-none"
                                />
                            </div>
                        </div>
