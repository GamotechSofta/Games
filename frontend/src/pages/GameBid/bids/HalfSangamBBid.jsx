...
const HalfSangamBBid = ({ market, title }) => {
    ...
    const submitBtnClass = (enabled) =>
        enabled
            ...
            : 'w-full bg-gradient-to-r bg-white/20 text-gray-400 font-bold py-3.5 min-h-[48px] rounded-lg shadow-md opacity-50 cursor-not-allowed';
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex flex-row items-center gap-2">
                                <label className="text-gray-800 dark:text-gray-200 text-sm font-medium shrink-0 w-40">Enter Open Ank:</label>
                                <input
                                    type="text"
                                    inputMode="numeric"
                                    value={openAnk}
                            ...
                            <div className="flex flex-row items-center gap-2">
                                <label className="text-gray-800 dark:text-gray-200 text-sm font-medium shrink-0 w-40">Enter Close Pana:</label>
                                <input
                                    type="text"
                                    inputMode="numeric"
                                    value={closePana}
