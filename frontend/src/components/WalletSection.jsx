...
const WalletSection = () => {
  ...
  return (
    <section className="w-full bg-[#f5f5f7] dark:bg-black pt-0 pb-1 sm:pb-3 sm:pt-0 max-w-full overflow-x-hidden">
      <BannersSection />
      ...
      <div className="md:hidden flex items-center justify-center mt-4 min-[375px]:mt-5 sm:mt-6 mb-4 min-[375px]:mb-5 sm:mb-6 w-full max-w-lg mx-auto gap-1 min-[375px]:gap-2 sm:gap-4">
        <div className="flex-1 h-[2px] bg-gray-300 dark:bg-white shrink min-w-0" />
        <div className="flex items-center gap-2 shrink-0">
          <svg className="w-2.5 h-2.5 text-[#d4af37]" viewBox="0 0 12 12" fill="currentColor">
            <path d="M6 0l1.8 4.2L12 6l-4.2 1.8L6 12l-1.8-4.2L0 6l4.2-1.8z"/>
          </svg>
          <h2 className="text-gray-900 dark:text-white text-sm min-[375px]:text-base sm:text-xl font-bold tracking-[0.15em] uppercase">
