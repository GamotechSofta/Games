...
class _CpCommonBidScreenState extends State<CpCommonBidScreen> {
  ...
  static final List<String> _doublePanas = allValidDoublePanas().toList()
    ..sort();
              ...
              Row(
                children: [
                  Checkbox(
                    ...
                    side: BorderSide(
                      color: GameBidUi.numberChipBorderColor(context),
                    ),
                  ),
                  Text(
                    'SP',
                    style: TextStyle(color: GameBidUi.onSurface(context)),
                  ),
          ...
          if (_includeTriple) ...[
            ...
            if (_selectedDigits.isEmpty)
              Text(
                ...
                style: GameBidUi.emptyHint(context).copyWith(height: 1.3),
              )
            else
              Wrap(
                spacing: 8,
