                    ...
                    <div className="flex flex-col gap-3 w-full md:w-1/2 shrink-0 min-w-0">
                        <div>
                            ...
                            <div className="flex items-center gap-2 mt-3">
                                <label className="shrink-0 w-24 text-xs sm:text-sm font-semibold text-gray-400">Enter Digit</label>
                                <input
                                    type="text"
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                type="button"
                                onClick={clearLocal}
                                className="min-h-[40px] h-10 px-4 rounded-md text-xs sm:text-sm font-bold border border-[#d4af37]/40 text-amber-800 dark:text-[#f2c14e] bg-white dark:bg-[#202124] hover:bg-[#d4af37]/5 active:scale-[0.98] transition-all shrink-0"
                            >
                                Clear
                            </button>
                        </div>
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className={`flex-1 bg-[#d4af37] text-[#4b3608] font-bold py-3.5 min-h-[48px] rounded-lg shadow-lg hover:bg-[#e5c04a] transition-all active:scale-[0.98] ${
