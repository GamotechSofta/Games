...
class _AppHeaderState extends State<AppHeader> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    final user = _user;
    final hasUser = AuthService.isLoggedInUser(user);
            ...
            child: Row(
              children: [
                ...
                Material(
                  ...
                  child: InkWell(
                    onTap: () {
                      navigateMainRoute(widget.shellContext, '/funds');
                    },
...
class _DepositButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final scheme = Theme.of(context).colorScheme;
    final bg = casinoStyle
        ? AppColors.gold.withValues(alpha: 0.14)
        : scheme.primaryContainer.withValues(alpha: 0.85);
    final border = casinoStyle
        ? AppColors.gold.withValues(alpha: 0.45)
        : scheme.primary.withValues(alpha: 0.35);
    final fg = casinoStyle ? AppColors.gold : scheme.onPrimaryContainer;
