  ...
  Future<void> _submit() async {
    ...
    await showBidReviewDialog(
      ...
      rows: rows
          .map(
            (r) => BidRowVm(
              id: Object.hash(r.number, r.points),
              number: r.number,
              points: r.points,
              sessionLabel: 'OPEN',
            ),
        ...
        children: [
          ...
          Row(
            children: [
              Text(
                'Quick points',
                style: GameBidUi.sectionLabel(context).copyWith(fontSize: 11),
              ),
              const Spacer(),
              TextButton(
          ...
          if (_activeQuickPoint != null)
            Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                  color: GameBidUi.onSurfaceMuted(context, 0.78),
                  fontSize: 10,
                ),
              ),
            ),
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 9,
                          fontWeight: FontWeight.w600,
                          color: GameBidUi.onSurfaceMuted(context, 0.85),
                        ),
                      ),
                    ),
                    ...
                    for (final c in _digits)
                      Builder(
                        builder: (context) {
                          final colHasText =
                              _colBulkCtrls[c]!.text.trim().isNotEmpty;
                          return SizedBox(
                        width: 38,
                        child: Padding(
                  ...
                  Row(
                    children: [
                      ...
                      Builder(
                        builder: (context) {
                          final rowHasText =
                              _rowBulkCtrls[r]!.text.trim().isNotEmpty;
                          return SizedBox(
                        width: 54,
                        child: Padding(
                          padding: const EdgeInsets.all(1),
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      style: TextStyle(
                                        fontSize: 8,
                                        color: hasPoints
                                            ? GameBidUi.onSurface(context)
                                            : GameBidUi.onSurfaceMuted(
                                                context,
                                                0.75,
                                              ),
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        enabledBorder:
                                            GameBidUi.bulkMatrixCellBorder(
                                          context,
                                          hasPoints: hasPoints,
                                        ),
                                      ),
