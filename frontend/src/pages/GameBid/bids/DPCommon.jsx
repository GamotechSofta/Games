            ...
            <div className="p-3 sm:p-4 pb-24 md:pb-6 sm:pb-8 min-h-0">
                ...
                <div className="flex flex-col md:flex-row gap-4 sm:gap-5 items-stretch md:items-start">
                    <div className="flex flex-col gap-3 w-full md:w-1/2 shrink-0 min-w-0">
                        <div>
                            <label className="block text-xs sm:text-sm font-semibold text-gray-400 mb-1.5">
                                Enter Digit (0-9)
                            </label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block text-xs sm:text-sm font-semibold text-gray-400 mb-1.5">Enter Points</label>
                            <input
                                type="text"
                                inputMode="numeric"
                                value={pointsInput}
                ...
                <div className="flex flex-col gap-2 mt-4">
                    ...
                    <button
                        ...
                        className={`w-full bg-[#d4af37] text-[#4b3608] font-bold py-3.5 min-h-[52px] rounded-lg shadow-lg hover:bg-[#e5c04a] transition-all active:scale-[0.98] ${
