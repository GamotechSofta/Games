...
class _SingleDigitBidScreenState extends State<SingleDigitBidScreen> {
  ...
  bool _specialQuickChipSelected(int p) =>
      _spec.values.every((c) => c.text.trim() == '$p');

  Future<void> _openReview() async {
    final addedNow = !_special
        ? _materializePendingEasy()
        : _materializePendingSpecial();
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: GameBidUi.panelTitle(context),
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        TextButton(
                          ...
                          onPressed: !_canMasterClearSpecial
                              ? null
                              : _masterClearSpecial,
                    ...
                    const SizedBox(
                      height: GameBidUi.quickPointsHeaderToChipsGap,
                    ),
                    Wrap(
                      spacing: 8,
                      runSpacing: 8,
                    ...
                    const SizedBox(height: 12),
                    ...List.generate(10, (i) {
                      final pts = int.tryParse(_spec[i]!.text) ?? 0;
                      return Padding(
