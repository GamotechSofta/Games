...
import 'bet_placed_success_dialog.dart';
                      ...
                      Expanded(
                        child: OutlinedButton(
                          ...
                          style: OutlinedButton.styleFrom(
                            foregroundColor: GameBidUi.onSurface(context),
                          ...
                          onPressed: cannot || _submitting
                              ...
                              : () async {
                                  ...
                                  try {
                                    ...
                                    if (!context.mounted) return;
                                    await showBetPlacedSuccessDialog(
                                      context,
                                      message: placeRes.message,
                                      newBalance: placeRes.newBalance,
                                      betCount: widget.rows.length,
                                      totalAmount: totalAfter,
                                    );
                                    if (!context.mounted) return;
                                    Navigator.pop(context);
