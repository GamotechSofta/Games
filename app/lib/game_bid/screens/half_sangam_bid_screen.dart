...
class _HalfSangamBidScreenState extends State<HalfSangamBidScreen> {
  ...
  void _add() {
    ...
    setState(() {
      final idx = _bids.indexWhere(
        (e) => e.number == key && e.session == _session,
      );
      if (idx >= 0) {
  ...
  Future<void> _submit() async {
    ...
    final active = _bids
        .where((e) => (int.tryParse(e.points) ?? 0) > 0)
        .toList();
      ...
      body: ListView(
        ...
        children: [
            ...
            children: [
              Expanded(
                ...
                child: Text(
                  ...
                  style: GameBidUi.tableHeader(context),
                ),
              ),
              Expanded(
                flex: 2,
          ...
          Divider(
            ...
            color: GameBidUi.isLight(context)
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 12,
                          color: GameBidUi.listPointsTextColor(context),
