                                ...
                                <div className="flex flex-row items-center gap-2">
                                    ...
                                    <div className="flex-1 min-w-0 grid grid-cols-5 gap-2">
                                        {quickPointValues.map((pts) => (
                                            <button key={pts} type="button" onClick={() => handleQuickPointClick(pts)} className="py-2 min-h-[36px] rounded-lg border-2 border-white/10 bg-white text-sm font-medium text-[#f2c14e] hover:border-[#d4af37] active:scale-95">
                                                {pts}
                                            </button>
                                        ))}
                                    </div>
