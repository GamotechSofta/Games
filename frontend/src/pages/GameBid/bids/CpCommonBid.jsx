                            ...
                            <div className="mb-2">
                                <div className="flex items-center justify-between mb-1 gap-3">
                                    ...
                                    <div className="flex items-center gap-2 sm:gap-3">
                                        ...
                                        <input
                                            type="checkbox"
                                            className="h-5 w-5 sm:h-6 sm:w-6 rounded border-2 border-red-300 dark:border-white/20 text-red-700 dark:text-red-300 focus:ring-red-200 dark:focus:ring-white/10"
                                            checked={includeSp}
