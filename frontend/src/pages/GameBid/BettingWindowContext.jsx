...
function MarketClosedModal({ market, allowed }) {
    ...
    return (
        ...
        >
            <div className="relative w-full max-w-sm rounded-2xl bg-white dark:bg-[#202124] shadow-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
                <button
                    type="button"
                    onClick={goHome}
                    className="absolute top-3 right-3 p-2 rounded-full text-gray-400 hover:text-gray-900 dark:text-white hover:bg-white/10 transition-colors"
                    aria-label="Close"
                >
