                        ...
                        return (
                            <View key={groupKey} style={s.group}>
                                <View style={s.groupHeader}>
                                    ...
                                    />
                                    <TouchableOpacity style={[s.applyBtn, !groupBulk[groupKey] && s.applyBtnDisabled]} onPress={() => { haptics.light(); groupBulk[groupKey] && applyGroup(groupKey, groupBulk[groupKey]); }} disabled={!groupBulk[groupKey]}>
                                        <Text style={s.applyBtnText}>{t('gameBid.apply')}</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={s.clearBtn} onPress={() => { haptics.light(); clearGroup(groupKey); }}>
...
const s = StyleSheet.create({
    ...
    groupLabel: { width: 44, minHeight: bidTokens.touchMin, backgroundColor: '#202124', borderTopLeftRadius: 6, borderBottomLeftRadius: 6, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', alignItems: 'center', justifyContent: 'center' },
    ...
    clearBtn: { paddingHorizontal: 12, minHeight: bidTokens.touchMin, backgroundColor: '#202124', borderRadius: 6, borderWidth: 1, borderColor: 'rgba(239,68,68,0.4)', alignItems: 'center', justifyContent: 'center' },
