    ...
    <div className="min-h-screen bg-black text-white px-3 sm:px-6 md:px-8 pb-[calc(6rem+env(safe-area-inset-bottom,0px))]">
      <div className="w-full max-w-xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="mt-6 rounded-2xl bg-gradient-to-br from-white/[0.07] to-white/[0.02] border border-white/10 overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-sm sm:text-base">
                ...
                <tbody>
                  {rows.map((row) => (
                    <tr key={row.game} className="border-b border-white/5 last:border-b-0 hover:bg-white/[0.03]">
                      <td className="py-3 px-4 text-gray-400">{row.srNo}</td>
                      <td className="py-3 px-4 font-medium text-white">{row.game}</td>
