...
class _SpMotorBidScreenState extends State<SpMotorBidScreen> {
  ...
  void _toggleDigit(int d) {
    setState(() {
      ...
      _digitsCtrl.text = sanitizeMotorDigitsUnique(
        (_selectedDigits.toList()..sort()).join(),
      );
    });
    _scheduleGenerate();
  }
  ...
  Future<void> _submit() async {
    ...
    if (active.isEmpty) {
      _toast(
        'Add at least one combination with points, or generate and then submit.',
      );
      return;
    }
        ...
        children: [
          ...
          TextField(
            ...
            onChanged: (v) => setState(() {
              ...
              _digitsCtrl.value = _digitsCtrl.value.copyWith(
                text: clean,
