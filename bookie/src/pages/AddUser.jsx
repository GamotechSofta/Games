        ...
        <Layout title="Add Player">
            <div className="max-w-4xl mx-auto">
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        <h1 className="bookie-page-title flex items-center gap-3">
                            Add New Player
                        </h1>
                        <p className="bookie-page-desc">Create a new player account and assign initial balance.</p>
                    </div>
                </div>
                ...
                {success && (
                    <div className="mb-6 p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-xl text-emerald-800 flex items-center gap-3">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 rounded-xl bg-white border border-slate-200 text-slate-900 placeholder-slate-600 focus:outline-none focus:border-amber-500/50 transition-colors"
                                    required
                                />
                            </div>
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-slate-600 uppercase tracking-wider">Password <span className="text-red-500">*</span></label>
                                <input
                                    type="password"
                                    name="password"
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-slate-600 uppercase tracking-wider">Role <span className="text-red-500">*</span></label>
                                <select
                                    name="role"
                                    value={formData.role}
                                    onChange={handleChange}
                                    className="w-full px-4 py-3 rounded-xl bg-white border border-slate-200 text-slate-900 focus:outline-none focus:border-amber-500/50 transition-colors appearance-none"
                                    required
                                >
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-slate-600 uppercase tracking-wider">Initial Balance</label>
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        step="0.01"
                                        placeholder=""
                                        className="w-full pl-10 pr-4 py-3 rounded-xl bg-white border border-slate-200 text-slate-900 placeholder-slate-600 focus:outline-none focus:border-amber-500/50 transition-colors font-mono"
                                    />
                                </div>
                            </div>
                            ...
                            {needsSecurityPassword && (
                                <div className="md:col-span-2 space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full max-w-xs px-4 py-3 rounded-xl bg-white border border-slate-200 text-slate-900 placeholder-slate-600 focus:outline-none focus:border-amber-500/50 transition-colors"
                                        autoComplete="off"
                                    />
                                </div>
                            )}
