...
const SummaryCard = ({ label, value, icon: Icon, gradient, iconBg, iconColor, sub }) => (
    <div className={`glass-panel glass-panel-card p-6 rounded-2xl relative overflow-hidden group hover:scale-[1.02] transition-transform duration-300`}>
        ...
        <div className="relative z-10">
            <div className={`w-12 h-12 rounded-xl ${iconBg} flex items-center justify-center mb-4 border border-white/10`}>
...
const StatBox = ({ label, value, color = 'text-white', borderColor = 'border-white/5' }) => (
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-slate-400 text-sm mt-1">
                            Performance summary for <span className="text-white font-medium">{formatRangeLabel(dateRange.startDate, dateRange.endDate)}</span>
                        </p>
                    </div>
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="glass-panel glass-panel-card p-6 rounded-2xl border border-white/10">
                                ...
                                <div className="mt-8 pt-6 border-t border-white/5">
                                    <div className="flex items-center justify-between mb-3">
                                        ...
                                        <span className="text-sm font-bold text-white mb-1 block">{report.winRate}%</span>
                                    </div>
                            ...
                            <div className="glass-panel glass-panel-card p-6 rounded-2xl border border-white/10">
                                ...
                                <div className="space-y-4 font-mono text-sm">
                                    {isBookieCollects ? (
                                        <>
                                            <div className="flex justify-between items-center py-3 px-4 rounded-xl bg-black/20 border border-white/5">
                                                <span className="text-slate-400 font-sans">Bet Volume</span>
                                                <span className="font-bold text-white">{formatCurrency(report.totalRevenue)}</span>
                                            </div>
                                            <div className="flex justify-between items-center py-3 px-4 rounded-xl bg-black/20 border border-white/5">
                        ...
                        <div className="flex justify-end">
                            <button
                                type="button"
                                onClick={handlePrint}
                                className="inline-flex items-center gap-2 px-6 py-3 bg-white/5 hover:bg-white/10 text-white rounded-xl text-sm font-bold transition-colors border border-white/10"
                            >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            {[
                                ...
                                >
                                    ...
                                    <div>
                                        <p className="font-bold text-white text-sm group-hover:text-amber-400 transition-colors">{item.label}</p>
