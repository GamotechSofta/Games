...
const Login = () => {
  ...
  const isPasswordLogin = location.pathname === '/login/password';
        ...
        <div className="w-full max-w-[360px] rounded-2xl border border-[#1b2a43] bg-gradient-to-b from-[#0a1220] to-[#060c17] p-5 shadow-[0_0_50px_rgba(220,38,38,0.12)]">
          ...
          {isPasswordLogin ? (
            <form onSubmit={handlePasswordSubmit} className="space-y-3">
              ...
              <button type="button" onClick={() => navigate('/login')} className="w-full text-center text-xs text-[#8fa0b7] underline hover:text-white">
            ...
            <form onSubmit={handleSendOtp} className="space-y-3">
              ...
              <button type="button" onClick={() => navigate('/login/password')} className="w-full text-center text-xs text-[#8fa0b7] underline hover:text-white">
