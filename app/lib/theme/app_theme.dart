...
ThemeData buildLightAppTheme() {
  final scheme = ColorScheme.fromSeed(
    seedColor: const Color(0xFF0EA85F),
    brightness: Brightness.light,
  ).copyWith(
    primary: const Color(0xFF0EA85F),
    onPrimary: Colors.white,
    primaryContainer: const Color(0xFFCEF5DF),
    onPrimaryContainer: const Color(0xFF063A20),
    secondary: const Color(0xFF1F8A6A),
    ...
    surfaceContainerHighest: const Color(0xFFE5EAF1),
    error: const Color(0xFFB42318),
    onError: Colors.white,
    outline: const Color(0xFFD0D7E2),
