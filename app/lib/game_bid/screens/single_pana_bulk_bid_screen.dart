...
class SinglePanaBulkBidScreen extends StatefulWidget {
  ...
  @override
  State<SinglePanaBulkBidScreen> createState() =>
      _SinglePanaBulkBidScreenState();
}
...
class _SinglePanaBulkBidScreenState extends State<SinglePanaBulkBidScreen> {
  ...
  String _sanitize(String v) => v
      ...
      .trim()
      .substring(0, v.replaceAll(RegExp(r'\D'), '').trim().length.clamp(0, 6));
  ...
  List<_PanaLine> _selectedLines() {
    ...
    for (final entry in _specialInputs.entries) {
      ...
      if (pts > 0) {
        out.add(
          _PanaLine(number: entry.key, points: '$pts', session: _session),
        );
      }
    }
    return out;
      ...
      body: ListView(
        ...
        children: [
          ...
          Text(
            ...
            style: GameBidUi.emptyHint(context).copyWith(height: 1.35),
          ),
          ...
          Align(
            ...
            child: OutlinedButton(
              onPressed: _clearAll,
              style: GameBidUi.quickPointsClearOutlinedStyle(context),
          ...
          ...List<Widget>.generate(10, (idx) {
            ...
            final groupHasText =
                _groupBulkCtrls[groupKey]?.text.trim().isNotEmpty ?? false;
            return Padding(
              padding: const EdgeInsets.only(bottom: 12),
              child: GameBidUi.bulkPanaSumGroupCard(
                context: context,
                child: GameBidUi.bulkPanaSumGroupBody(
                  children: [
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        GameBidUi.bulkPanaDigitChip(context, label: groupKey),
                          ...
                          child: GameBidUi.betPointsRectangleSlot(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintStyle: GameBidUi.bulkMatrixPtsHintStyle(
                                  context,
                                  fontSize: 11,
                                ),
                                filled: true,
                                fillColor: GameBidUi.bulkMatrixCellFill(
                                  context,
                                  hasPoints: groupHasText,
                                ),
                                border: GameBidUi.bulkMatrixCellBorder(
                                  context,
                                  hasPoints: groupHasText,
                                  radius: GameBidUi.bulkPanaFieldRadius,
                                ),
                                enabledBorder: GameBidUi.bulkMatrixCellBorder(
                                  context,
                                  hasPoints: groupHasText,
                                  radius: GameBidUi.bulkPanaFieldRadius,
                                ),
                                contentPadding:
                                    GameBidUi.bulkPanaPointsFieldPadding,
                              ),
                            ),
                          ),
                        ),
                        ...
                        OutlinedButton(
                          onPressed:
                              (_groupBulkCtrls[groupKey]?.text.trim().isEmpty ??
                                  true)
                              ? null
                              : () => _applyGroup(groupKey),
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          'Quick points',
                          style: GameBidUi.sectionLabel(context),
                        ),
                              ...
                              children: _quickPoints.map((p) {
                                ...
                                return Padding(
                                  ...
                                  child: GameBidUi.quickPointsChip(
                                    ...
                                    onSelected: (_) =>
                                        _applyQuickGroupPoints(groupKey, p),
                                  ),
                                );
                              }).toList(),
                            ),
                    ...
                    GridView.builder(
                      ...
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        ...
                        mainAxisExtent: GameBidUi.bulkPanaGridRowExtent,
                      ),
                      ...
                      itemBuilder: (context, i) {
                        ...
                        return GameBidUi.bulkPanaGridCell(
                          child: Row(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            GameBidUi.bulkPanaDigitChip(context, label: num),
                            SizedBox(width: AppSpacing.sm),
                            Expanded(
                              child: GameBidUi.betPointsRectangleSlot(
                                extent: GameBidUi.bulkPanaInlineRowHeight,
                                child: TextFormField(
                                  ...
                                  onChanged: (v) => setState(
                                    () => _specialInputs[num] = _sanitize(v),
                                  ),
                                  onTap: () {
                                    if (_groupQuickSelection[groupKey] !=
                                        null) {
                                      setState(
                                        () => _groupQuickSelection[groupKey] =
                                            null,
                                      );
                                    }
                                  },
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    constraints: const BoxConstraints(
                                      minHeight:
                                          GameBidUi.bulkPanaInlineRowHeight,
                                      maxHeight:
                                          GameBidUi.bulkPanaInlineRowHeight,
                                    ),
                                    hintText: 'Pts',
          ...
          const SizedBox(height: 6),
          if (selected.isEmpty)
            Text('No selected pana yet', style: GameBidUi.emptyHint(context))
          else
            ...selected
                .take(30)
                .map(
