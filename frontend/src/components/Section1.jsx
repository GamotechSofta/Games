...
const Section1 = () => {
  ...
  return (
    <section className="w-full bg-[#f5f5f7] dark:bg-black min-[375px]:pt-4 pb-[calc(5rem+env(safe-area-inset-bottom,0px))] sm:pt-6 sm:pb-10 min-[375px]:px-3 sm:px-4 md:pb-8 max-w-full overflow-x-hidden">
      {/* Desktop quick-nav row removed — desktop uses Home dashboard (sidebar + QuickNavCards) */}
      <div className="hidden items-center gap-4 mt-4 mb-5 w-full max-w-7xl mx-auto px-4" aria-hidden>
      ...
      <div className="flex md:hidden items-end justify-center mb-4 min-[375px]:mb-6 sm:mb-8 w-full max-w-7xl mx-auto">
        ...
        <div className="relative shrink-0 w-[110px] min-[375px]:w-[140px] sm:w-[180px] h-[24px] min-[375px]:h-[28px] sm:h-[34px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center pt-2 sm:pt-3">
            <h2 className="text-gray-900 dark:text-white text-sm min-[375px]:text-base sm:text-xl font-bold tracking-wider">{t('markets.markets').toUpperCase()}</h2>
          </div>
        </div>
        <div className="flex-1 h-[2px] bg-[#d4af37] shrink min-w-0" />
      </div>
            ...
            >
              ...
              {market.status === 'closed' ? (
                <button
                  ...
                  className="mt-auto pt-1.5 border-t border-white/5 text-amber-400 text-[10px] min-[375px]:text-[11px] sm:text-sm font-semibold text-center whitespace-nowrap hover:text-amber-300 w-full animate-pulse"
                >
