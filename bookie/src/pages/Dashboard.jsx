...
const SkeletonCard = () => (
    <div className="bg-gray-800/60 rounded-xl p-5 border border-gray-700/50 animate-pulse">
        ...
        <Layout title="Dashboard">
            ...
            {hasActionRequired && (
                <div className="mb-6 p-4 rounded-xl bg-amber-500/10 border border-amber-500/40">
                    ...
                    <div className="flex flex-wrap gap-3">
                        {pendingPayments > 0 && (
                            <Link to="/payments" className="px-4 py-2 rounded-lg bg-amber-600 hover:bg-amber-500 text-black font-medium text-sm">
            ...
            <div className="bg-gray-800/60 rounded-xl p-5 border border-gray-700">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
                    <Link to="/my-users" className="px-4 py-3 rounded-lg bg-gray-700 hover:bg-amber-500/20 border border-gray-600 hover:border-amber-500/60 text-gray-200 hover:text-amber-400 text-sm font-medium transition-all text-center">
                        My Players
                    </Link>
                    ...
                    <Link to="/referral-link" className="px-4 py-3 rounded-lg bg-gray-700 hover:bg-amber-500/20 border border-gray-600 hover:border-amber-500/60 text-gray-200 hover:text-amber-400 text-sm font-medium transition-all text-center">
                        Referral Link
                    </Link>
                    <Link to="/bet-history" className="px-4 py-3 rounded-lg bg-gray-700 hover:bg-amber-500/20 border border-gray-600 hover:border-amber-500/60 text-gray-200 hover:text-amber-400 text-sm font-medium transition-all text-center">
                        Bet History
                    </Link>
                    <Link to="/reports" className="px-4 py-3 rounded-lg bg-gray-700 hover:bg-amber-500/20 border border-gray-600 hover:border-amber-500/60 text-gray-200 hover:text-amber-400 text-sm font-medium transition-all text-center">
                        Reports
                    </Link>
                </div>
            </div>
